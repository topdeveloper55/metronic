    ...
    >
      ...
      >
        ...
        <div className='card-body px-6 px-lg-10 px-xxl-15 py-20'>
          <div className='d-flex flex-column flex-center py-15 px-5'>
            {/* begin::Logo */}
            ...
            <div className='stepper-item current' data-kt-stepper-element='nav'>
              ...
              <div className='stepper-wrapper'>
                ...
                <div className='stepper-label'>
                  ...
                  <div className='stepper-desc fw-semibold'>Setup Your Account Type</div>
                </div>
                {/* end::Label*/}
              </div>
              {/* end::Wrapper*/}
            ...
            <div className='stepper-item' data-kt-stepper-element='nav'>
              ...
              <div className='stepper-wrapper'>
                ...
                <div className='stepper-label'>
                  ...
                  <div className='stepper-desc fw-semibold'>Your Account Created</div>
                </div>
                {/* end::Label*/}
              </div>
              {/* end::Wrapper*/}
